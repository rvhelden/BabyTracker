        ...
        <div className="invite-ready">
          ...
          {isLoggedIn ? (
            <div className="invite-actions">
              <button className="btn btn-primary auth-btn" onClick={handleAccept} disabled={pending}>
            ...
            <>
              <p className="invite-login-hint">Sign in or create an account to accept this invite.</p>
              <div className="invite-actions">
                <Link href={`/login?from=/invite/${token}`} className="btn btn-primary auth-btn" style={{ textAlign: 'center' }}>
                  Sign In
                </Link>
                <Link href="/signup" className="btn btn-secondary auth-btn" style={{ textAlign: 'center' }}>
                  Create Account
                </Link>
              </div>
            </>
